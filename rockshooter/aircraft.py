...
class AirCraft:
	...
	def draw(self):
		Game.screen.blit(self.airCraftImage, self.airCraftPosition)
	...
	def moveRight(self):
		airCraftPositionX = self.airCraftPosition[0] + 5
		if (airCraftPositionX == Game.screenSize[0]):
	...
	def moveUp(self):
		...
		if (airCraftPositionY == Game.screenSize[1]):
			self.airCraftPosition = (self.airCraftPosition[0], self.airCraftPosition[1])
		else:
...
class Bullet:
	...
	def draw(self):
		Game.screen.blit(self.bulletImage, self.bulletPosition)
